...
<div class="conteudo">
	<?php
		...
		$sql = "SELECT idClientes, nomeCliente, email, dataCadastro FROM clientes ORDER BY nomeCliente ASC";
	...
	<div id="listadeclientes">
		...
		<table width = "85%" border="1" align="center">
			<thead>
				<tr>
					<th><center>Id do cliente</center></th>
					<th><center>Nome do cliente</center></th>
					<th><center>Email do cliente</center></th>
			...
			<tbody>
				...
				<tr>
					...
					<td><a href="form-edit.php?id=<?php echo $cliente['idClientes']?>"> Editar </a><a href="delete.php?id=<?php echo  $cliente['idClientes'] ?>" onclick="return  confirm('Tem certeza que deseja  excluir?');"> Excluir </a></td>
				</tr>
				<?php endwhile; ?>
			</tbody>
		</table>
	...
	<div id="adiciona">
	<button type="button" href="form-add.php" onClick="chamaajax(this)"> Novo cliente </button>
	</div>
</div>
<!------------------------------------------------------------------------------------------------------------------------------ -->
<!-- Footer -->
